...
import profilePic from '../resources/my.jpg'
import '../css/HomeProfile.css'
import resume from '../resources/Nitigya.docx'
        ...
        <div className="row homeProfile">
            <div className="content col-md-6 col-xs-12">
                <div className="content__text">
                    ...
                    <div className="glitch" data-text="Nitigya Jain">
                        Nitigya Jain
                    </div>
                    <Typewriter
                        options={{
                            strings: ['Coder', 'Web Developer', 'Blockchain Developer'],
                            autoStart: true,
                            loop: true,
                        }}
                    />
